...
### 1. [Tổng Quan Hệ Thống & Phạm Vi Dự Án](file:///d:/vbay/report/overview.md)
...
### 2. [Hướng Dẫn Cài Đặt & Khởi Chạy](file:///d:/vbay/report/setup.md)
...
### 3. [Đặc Tả Giao Thức TCP Socket & JSON Protocol](file:///d:/vbay/report/protocol.md)
...
### 4. [Thiết Kế Cơ Sở Dữ Liệu MySQL](file:///d:/vbay/report/database-erd.md)
...
### 5. [Bản Đồ Thiết Kế Lớp & Sơ Đồ Sequence](file:///d:/vbay/report/class-diagram.md)
...
### 6. [Kiến Trúc Concurrency & Real-time Engines](file:///d:/vbay/report/realtime-architecture.md)
...
### 7. [Hướng Dẫn Kiểm Thử & Kiểm Định](file:///d:/vbay/report/testing-guide.md)
...
### 8. [Hướng Dẫn Sử Dụng Ứng Dụng](file:///d:/vbay/report/user-manual.md)
...
### 9. [Xử Lý Sự Cố & Hướng Dẫn Đóng Gói JAR](file:///d:/vbay/report/troubleshooting-release.md)
