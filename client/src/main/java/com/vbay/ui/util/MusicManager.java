...
public class MusicManager {
    ...
    public static void playBackgroundMusic() {
        try {
            ...
            File file = new File("music/Dung_Lam_Trai_Tim_Anh_Dau.mp3");
            if (!file.exists()) {
                file = new File("../music/Dung_Lam_Trai_Tim_Anh_Dau.mp3");
            }
            if (!file.exists()) {
                file = new File("c:/Users/Cuong/Desktop/java/vbay/music/Dung_Lam_Trai_Tim_Anh_Dau.mp3");
            }
